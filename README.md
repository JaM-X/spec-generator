...
The JaM-X platform intends to relief the development team from the need of having packaging expertise by automating most of the work and providing guided package generation wizards when manual intervention is necessary.
...
## spec-generator
This module is the part of JaM-X that handles the initial package spec generation.
